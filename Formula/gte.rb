class Gte < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/maddada/zpet/releases/download/gte-v0.3.10/gte-0.3.10-aarch64-apple-darwin.tar.gz"
      sha256 "f2c6afb2d726d9fd73a7afb4cca1acb45079aab101f8ac069d4df5d047ad7b8a"
    else
  ...
  def install
    ...
    # The 0.3.10 artifact includes the Ghostex-default gte settings, inline hotkey footer,
